...
export function HeroSection() {
  ...
  useEffect(() => {
    fetch("https://api.atelai.org/health")
      ...
      .then((data) => {
        setStats({
          agents: data.agents ? String(data.agents) : "306",
          orders: data.orders ? `${data.orders}+` : "300+",
        });
      })
        ...
        <div className="flex flex-col gap-8">
          ...
          >
            <Button
              ...
              asChild
            >
              <a href="https://atel-dashboard-gbylutr21-rikhuan93-gmailcoms-projects.vercel.app/dashboard">
                Get Started
            ...
            <Button
              ...
              asChild
            >
              <a href="https://atel-docs-69edbmsxl-rikhuan93-gmailcoms-projects.vercel.app">Read Docs</a>
            </Button>
            <Button
              size="lg"
              variant="outline"
